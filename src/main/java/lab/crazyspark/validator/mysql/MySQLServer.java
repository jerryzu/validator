...
public class MySQLServer {
    private static final String[] RESERVED_NAMES = { "accessible", "account", "action", "add", "after", "against",
            ...
            "isolation", "issuer", "iterate", "join", "json", "k", "key", "keys", "key_block_size", "kill", "language",
            ...
            "write", "x509", "xa", "xid", "xml", "xor", "year", "year_month", "zerofill", "zerofill"

    };

    public class ReservedMySQLObjectNames implements ReservedWords {
        // We return a constant here but could do a DB lookup, some calculation, or
        // whatever
        ...
        // kill any threads that try to load any code with annotations that reference
        // this.
        @Override
    ...
    @NotReservedWord(reserved = ReservedMySQLObjectNames.class, message = "error.hostname.reserved")
